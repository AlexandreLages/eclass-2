			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="card">
						...
						<div class="card-body">
							<form action="<c:url value="/disciplina/configura"/>" method="post">
								<div class="col-md-12">
									<div class="form-group">
	  									<label for="media">Média da Disciplina</label>
	  									<input type="text" class="form-control" id="media" name="media" placeholder="Ex.: 7.5" value="${disciplina.media}">
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
	  									<label for="alunosRanking">Número de Alunos no Ranking</label>
	  									<input type="text" class="form-control" id="alunosRanking" name="alunosRanking" placeholder="Ex.: 3" value="${disciplina.alunosRanking}">
									</div>
								</div>
								<div class="col-md-12">

			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="pull-right">
						<a href="<c:url value="/prova/lista/disciplina/${prova.disciplina.id}"/>" class="btn btn-warning">Voltar</a>
					</div>
					<br>
					<div class="card">
						...
						<div class="col-md-4">
							<div class="card center">
		  						<div class="card-body">
		    						...
		    						<a href="<c:url value="/nota/lista/prova/${prova.id}"/>"><i class="fas fa-chart-line fa-5x font-primary"></i></a>
		  						</div>
	  						</div>
						</div>
						<div class="col-md-4"> 
							<div class="card center">
		  						<div class="card-body">
		    						...
		    						<a href="<c:url value="/aluno/lista/disciplina/${prova.disciplina.id}"/>"><i class="fas fa-users fa-5x font-primary"></i></a>
		  						</div>
	  						</div>
						</div>
						<div class="col-md-4">
